...
public plugin_init()
{
  ...
  g_hhEnabledBlocks[HEB_TRACEATTACK] = RegisterHamPlayer(Ham_TraceAttack, "Ham_TraceAttack_pre", 0);
  g_hhEnabledBlocks[HEB_TAKEDAMAGE] = RegisterHamPlayer(Ham_TakeDamage, "Ham_TakeDamage_pre", 0);
  ...
  g_hhRegenBlocks[HEB_OTHER] = RegisterHamPlayer(Ham_TakeHealth, "Ham_TakeHealth_pre", 0);
