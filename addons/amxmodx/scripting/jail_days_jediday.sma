...
public plugin_init()
{
	...
	DisableHamForward((g_pHamHooks[0] = RegisterHam(Ham_Killed, "player", "Ham_Killed_pre", 0)));
	DisableHamForward((g_pHamHooks[1] = RegisterHam(Ham_Item_Deploy, "weapon_knife", "Ham_Item_Deploy_post", 1)));
#if defined JAIL_HAMBOTS
	DisableHamForwardBots((g_HamBotsKilled = RegisterHamBots(Ham_Killed, "Ham_Killed_pre", 0)));
#endif
