...
public plugin_init()
{
  ...
  cvar_jedi_maxspeed  = register_cvar_file("jail_jedi_maxspeed",  "290.0",  "Jedi speed. (Default: 290.0)");
  cvar_jedi_gravity   = register_cvar_file("jail_jedi_gravity",   "0.5",    "Jedi gravity. (Default: 0.5)");
  cvar_jedi_hp        = register_cvar_file("jail_jedi_hp",        "50",     "Jedi health. (Default: 50)");
