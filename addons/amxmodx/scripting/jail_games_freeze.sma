...
public plugin_init()
{
	...
	DisableHamForward((g_pHamForwards[0] = RegisterHam(Ham_Touch, "player", "Ham_Touch_pre", 0)));
	DisableHamForward((g_pHamForwards[1] = RegisterHam(Ham_TraceAttack, "player", "Ham_TraceAttack_pre", 0)));
	DisableHamForward((g_pHamForwards[2] = RegisterHam(Ham_Killed, "player", "Ham_Killed_pre", 0)));

#if defined JAIL_HAMBOTS
	DisableHamForwardBots((g_pHamTouchBotsForward = RegisterHamBots(Ham_Touch, "Ham_Touch_pre", 0)));
#endif
...
my_registered_stuff(val)
{
	if(val)
	{
		...
		#if defined JAIL_HAMBOTS
		EnableHamForwardBots(g_pHamTouchBotsForward);
		#endif
	...
	else
	{
		...
		#if defined JAIL_HAMBOTS
		DisableHamForwardBots(g_pHamTouchBotsForward);
		#endif
