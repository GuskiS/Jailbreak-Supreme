...
public plugin_init()
{
  ...
  cvar_freeze_maxspeed    = register_cvar_file("jail_freeze_maxspeed",    "330.0",  "Freeze speed for catchers. (Default: 330.0)");
  cvar_freeze_time_delay  = register_cvar_file("jail_freeze_time_delay",  "30.0",   "Time before start of Freeze game. (Default: 30.0)");
