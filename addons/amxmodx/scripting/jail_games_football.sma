...
public plugin_init()
{
	...
	DisableHamForward((g_pHamHooks[2] = RegisterHam(Ham_CS_Player_ResetMaxSpeed, "player", "Ham_Player_ResetMaxSpeed_post", 1)));
	DisableHamForward((g_pHamHooks[3] = RegisterHam(Ham_ObjectCaps, "player", "Ham_ObjectCaps_post", 1))); // using this instead of EmitSound to steal ball
