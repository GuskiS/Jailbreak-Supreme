...
public plugin_init()
{
  ...
  cvar_ball_speed     = register_cvar_file("jail_ball_speed",     "230.0",  "Player movement speed with ball. (Default: 230.0)");
  cvar_ball_velocity  = register_cvar_file("jail_ball_velocity",  "600",    "Ball kick speed. (Default: 600)");
