...
public plugin_init()
{
  ...
  cvar_remove_money     = register_cvar_file("jail_remove_money",     "1", "Removes money. (Default: 1)");
  cvar_prisoner_grenade = register_cvar_file("jail_prisoner_grenade", "0", "Can prisoners pick nades? (Default: 0)");
